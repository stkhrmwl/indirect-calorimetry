...
const char *location = GCP_LOCATION;
const char *registry_id = CIOTC_REGISTRY_ID;
const char *device_id = CIOTC_DEVICE_ID;
...
const char *private_key_str = CIOTC_DEVICE_PRIVATE_KEY;
